...
public final class ArrayPractice {
    ...
    /**
     * Find pairs of elements whose sum is equal to {@code element} in the {@code values}.
     * @param element: the specified number.
     * @param values: the values to be searched in.
